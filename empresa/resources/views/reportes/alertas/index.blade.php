    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <small class="text-muted">
                @if($noLeidasCount > 0)
                    <span class="badge bg-danger">{{ $noLeidasCount }} no leída{{ $noLeidasCount !== 1 ? 's' : '' }}</span>
                @else
                    Todas leídas
                @endif
            </small>
                    ...
                    <div class="d-flex w-100 align-items-start gap-3">
                        ...
                        <div class="flex-grow-1">
                            <div class="d-flex justify-content-between align-items-start mb-1">
                                ...
                                <small class="text-muted text-nowrap ms-2">
                                    {{ $notif->fecha_creacion->diffForHumans() }}
                                </small>
                            </div>
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                ...
                                @if($notif->leida)
                                    <small class="text-muted">
                                        Recibida {{ \Carbon\Carbon::parse($notif->fecha_creacion)->diffForHumans() }}
                                    </small>
                        ...
                        <div class="flex-shrink-0 dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                @if(!$notif->leida)
                                    <li>
                                        <a class="dropdown-item" href="{{ route('reportes.alertas.marcar-leida', $notif->id_notificacion) }}">
